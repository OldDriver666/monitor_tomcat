...
public class SmsDemo {
	...
	static final String accessKeyId = "LTAIIwvyVeREB";
	static final String accessKeySecret = "g3EwarlgO9JE6j5pylO25e";
	...
	public static SendSmsResponse sendSms() throws ClientException {
		...
		// 必填:待发送手机号
		request.setPhoneNumbers("13128726378");
		// 必填:短信签名-可在短信控制台中找到举个例子
		request.setSignName("嘉华顺风");
		// 必填:短信模板id-可在短信控制台中找到，是id不是名字，举个例子
		request.setTemplateCode("SMS_992005");
